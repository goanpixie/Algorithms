 ...
 ********************************************************/
//if the input has a right child element,
/*if yes->traverse to right and then keep traversing to left till till gives onull, return previous node key
  ...
  if(cur.right){
    ...
    return cur;
     ...
     if(cur.key>inputNode.key){
       while(cur.left && cur.left.key>inputNode.key){
             cur = cur.left;
             }
       return cur;
     }
